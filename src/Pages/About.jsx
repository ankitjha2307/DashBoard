    ...
    <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-10 rounded-2xl shadow-lg">
        ...
        <h1 className="text-4xl font-extrabold mb-6 text-center">
          <span className="text-gray-800">Bharat</span>
          <span className="text-blue-600">Check</span>
        </h1>

        {/* Intro */}
        <p className="text-gray-700 text-lg leading-relaxed mb-8 text-center">
          <strong>BharatCheck</strong> is a compliance monitoring platform
          designed to help businesses and regulators ensure that products meet
          mandatory labeling and consumer safety requirements in India.
        </p>
        ...
        <section>
          ...
          <p className="text-gray-700 text-lg leading-relaxed space-y-2">
            📧 Email:{" "}
            <a
              href="mailto:support@bharatcheck.com"
